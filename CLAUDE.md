...
**Step 2: 輸出法人買超/賣超 TOP30（強制）** 🆕 2025-12-17更新
```markdown
...
**版本**：v5.6（台股時事分析工具）🔥
**重大更新**：
- 🆕 **fetch_tw_market_news.py 台股時事分析**（2026-01-20）
...
- 🆕 **法人TOP30篩選**：`fetch_institutional_top30.py` 自動標註5日漲幅+狀態
