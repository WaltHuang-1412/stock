...
**v7.7 更新重點**（已整合）：
1. ✅ Step 7：法人評分改回**張數排名**（`volume_rank`），最直觀反映法人買進力道
...
**法人數據（30分）評分依據**（v7.8 張數排名版）：

> 以 `institutional_top50.json` 的 `volume_rank`（張數排名）為主要依據。
> 張數排名直接反映法人實際買進的股數，最直觀。

| 張數排名 | 基礎分 | 說明 |
|---------|-------|------|
| **TOP10** (volume_rank ≤ 10) | 25-30分 | 法人大量買進 |
| **TOP11-20** (volume_rank 11-20) | 20-25分 | 法人買進中上 |
| **TOP21-35** (volume_rank 21-35) | 15-20分 | 法人買進一般 |
| **TOP36-50** (volume_rank 36-50) | 10-15分 | 法人買進偏低 |
