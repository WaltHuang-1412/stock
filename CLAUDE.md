...
### 🔴 Step 6: 時事展開（強制）🆕 v2.0 加深產業鏈

**目的**：從時事催化劑展開受惠產業鏈（1-3階）

**執行邏輯**：
1. 讀取 Step 1（國際市場）+ Step 2（台股時事）
2. 判斷今日催化方向（例：費半+2% → 半導體利多）
3. 查「時事→產業鏈→代表股」對照表（🆕 展開到2-3階）
4. 對代表股執行法人查詢
...
| 階層 | 產業 | 代表股（必查） | 備註 |
|------|------|---------------|------|
| **一階** | 晶圓代工 | 台積電(2330)、聯電(2303)、世芯-KY(3661) | 核心受惠 |
| **二階** | 載板/PCB | 欣興(3037)、景碩(3189)、南電(8046)、華通(2313) | 供應鏈 |
| **二階** | 封測 | 日月光(3711)、力成(6239)、京元電(2449)、南茂(8150) | 供應鏈 |
| **二階** | 記憶體 | 南亞科(2408)、華邦電(2344)、旺宏(2337) | 同步受惠 |
| **三階** | PCB材料 | 台光電(2383)、聯茂(6213) | 材料供應商 |
| **設備** | 半導體設備 | 弘塑(3131)、辛耘(3583)、家登(3680) | 資本支出 |

#### 🤖 AI伺服器需求（輝達/AMD漲 >3%）

| 階層 | 產業 | 代表股（必查） | 備註 |
|------|------|---------------|------|
| **一階** | 伺服器代工 | 廣達(2382)、緯創(3231)、鴻海(2317)、英業達(2356) | 核心受惠 |
| **二階** | 散熱模組 | 🆕 奇鋐(3017)、雙鴻(3324) | ⬅ **今天漏的** |
| **二階** | 伺服器PCB | 金像電(2368)、燿華(2367) | 供應鏈 |
| **三階** | 散熱風扇 | 建準(2421)、奇宏(3017) | 零組件 |
| **三階** | 機殼 | 鴻準(2354)、鎧勝-KY(5264) | 零組件 |
| **電源** | 電源供應器 | 台達電(2308)、康舒(6282)、光寶科(2301) | 關鍵零組件 |

#### 🛢️ 油價大漲 >2%

| 階層 | 產業 | 代表股（必查） | 利多/利空 |
|------|------|---------------|----------|
| **一階** | 塑化 | 台塑(1301)、南亞(1303)、台化(1326) | ✅ 利多 |
| **一階** | 航空 | 華航(2610)、長榮航(2618) | ❌ 利空 |
| **二階** | 塑膠製品 | 南寶(4766)、永記(4712) | ✅ 利多 |

#### 💰 金融利多（Fed降息、股市成交量大增）

| 階層 | 產業 | 代表股（必查） | 備註 |
|------|------|---------------|------|
| **一階** | 金控 | 富邦金(2881)、國泰金(2882)、兆豐金(2886) | 核心受惠 |
| **二階** | 證券 | 元大證(6005)、凱基證(6008) | 交易量受惠 |

**執行命令**（以費半+2%為例）：
```bash
# 🆕 v2.0 展開到二階、三階
python3 scripts/chip_analysis.py 2330 2303 3037 3711 8150 2383 3131
```
