...
**🆕 法人數據（30分）評分依據**（v7.4 金額排名版）：

> 以 `institutional_top50.json` 的 `amount_rank`（金額排名）為主要依據，取代張數排名。

| 金額排名 | 基礎分 | 說明 |
|---------|-------|------|
| **TOP10** | 25-30分 | 法人砸最多錢，高度關注 |
| **TOP11-20** | 20-25分 | 法人投入金額中上 |
| **TOP21-35** | 15-20分 | 法人投入金額一般 |
| **TOP36-50** | 10-15分 | 法人投入金額偏低 |
...
> **注意**：金額排名取代張數排名作為法人維度的主要依據。
> 張數排名仍供參考，但不作為評分主軸。
> 例：京元電 313 元 +5K 張 = 金額 16 億（TOP10），優先於凱基金 19 元 +40K 張 = 金額 7.7 億（TOP15）。
...
### 🔴 Step 3: Track B 尚未反映機會（強制）🆕 v7.5

**目的**：找出「法人在買但股價還沒動」的股票，提供可操作的進場機會
...
#### 3-2：按產業方向歸納，每個方向聚焦「尚未跟上」

每個方向的分析重點：
1. **為什麼有機會（📰）** — 同產業其他股已漲，催化劑是什麼
2. **法人在幹嘛（📊）** — 買超金額、連續天數、佔成交比
3. **具體標的（🎯）** — 只列「尚未跟上」的股票，給進場參考價
...
### ① 金融補漲
📰 開發金連7天+265K帶動金融族群，但合庫金尚未跟上
📊 合庫金：法人+50K（外資+投信同步買）、今日僅+0.21%
🎯 合庫金(5880) 現價26.5，法人持續買但股價未動，有補漲空間

### ② AI封測/載板
📰 AI散熱已大漲（超眾+9.8%），資金可能輪動到封測
📊 京元電：法人+1.5K、今日+1.56%（微漲）
🎯 京元電(2449) 現價313，同產業散熱股已漲但封測尚未跟上
```
